...
// flag for programmable buffer to use only in mode 1 and 2
...
//flag for non-programmable buffer to use only in mode 1 and 2
#define CAN_INTERRUPT_MODE1_RX_ALL_ON	0b00000011
#define CAN_INTERRUPT_MODE1_RX0_ON		0b00000001
#define CAN_INTERRUPT_MODE1_RX1_ON		0b00000010
#define CAN_INTERRUPT_MODE1_RX_ALL_OFF	0b00000000

#define CAN_INTERRUPT_MODE2_RX_ALL_ON	0b00000011
#define CAN_INTERRUPT_MODE2_RX0_ON		0b00000001
#define CAN_INTERRUPT_MODE2_RX1_ON		0b00000010
#define CAN_INTERRUPT_MODE2_RX_ALL_OFF	0b00000000

////flag for non-programmable buffer to use only in mode 0
#define CAN_INTERRUPT_MODE0_RX_ALL_ON	0b00000011
#define CAN_INTERRUPT_MODE0_RX1_ON		0b00000010
#define CAN_INTERRUPT_MODE0_RX0_ON		0b00000001
#define CAN_INTERRUPT_MODE0_RX_ALL_OFF	0b00000000

//flag for non-programmable buffer 
...
#define CAN_CONFIG CAN_INTERRUPT_TX_ALL_OFF | CAN_INTERRUPT_MODE2_RX_ALL_OFF | CAN_INTERRUPT_ERROR_ON | CAN_INTERRUPT_MESSAGE_ERROR_OFF
#define CAN_CONFIG_PROG CAN_INTERRUPT_PROG_ALL_OFF
...
//Error code
#define INVALID_BAUD_RATE 			0x01
#define BUFFER_RX_ERROR_OVERFLOW 	0x02
#define BUFFER_TX_BUS_OFF 			0x03
#define BUFFER_TX_BUS_PASSIVE 		0x04
#define BUFFER_RX_BUS_PASSIVE 		0x05
#define BUFFER_TX_WARNING 			0x06
#define BUFFER_RX_WARNING 			0x07
#define BUFFER_RX_ERROR_GENERIC 	0x08
#define INVALID_MESSAGE 			0x09
...
unsigned char can_buffer_rx_load();
