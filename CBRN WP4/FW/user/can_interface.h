...
#define CAN_CONFIG CAN_INTERRUPT_TX_ALL_ON | CAN_INTERRUPT_RX_ALL_ON | CAN_INTERRUPT_ERROR_ON | CAN_INTERRUPT_MESSAGE_ERROR_ON
...
extern struct CAN_STATUS
{
  ...
  unsigned buffer_rx_error		:1;	// error accured
};
...
extern unsigned int count;		// for test only: remove
