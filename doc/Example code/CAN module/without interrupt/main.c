...
*
* Module Description:
* This example dimostrate how to use the can module. The purpouse of this 
* firmware is initialize the can module and send a message through button
* b0. The can bus is initialized in loopback, so, as the button b0 is pressed
* the polling routing catch the message and print it on uart.
*
* Note:
