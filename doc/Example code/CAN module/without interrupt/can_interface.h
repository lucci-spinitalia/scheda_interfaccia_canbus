...
#define CAN_CONFIG CAN_INTERRUPT_TX_ON | CAN_INTERRUPT_RX_ON | CAN_INTERRUPT_ERROR_OFF
#define CAN_CONFIG_PROG_RX CAN_INTERRUPT_PROG_ALL_ON | CAN_INTERRUPT_RX_ALL_ON
#define CAN_CONFIG_TX CAN_INTERRUPT_TX_ALL_ON
